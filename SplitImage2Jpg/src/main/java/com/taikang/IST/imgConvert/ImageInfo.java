...
public class ImageInfo {
    ...
    public ImageInfo(String image_path, String image_type, String output_dir, int dpi) {
    ...
    public ImageInfo(String image_path, String image_type, String output_dir, int dpi, int page_num, int error_code, String error_msg) {
        m_image_path = image_path;
        m_image_type = image_type;
        m_output_dir = output_dir;
        m_dpi = dpi;
